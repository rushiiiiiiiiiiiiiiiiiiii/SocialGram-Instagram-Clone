        ...
        <div className='w-[965px] ml-[335px] mt-4  bg-white rounded-xl'>
            <div className="prof-dte flex gap-20 ml-24 mt-5 border-b-2 border-gray-500 pb-[30px] w-[760px]">
                ...
                <div className="div">
                    <div className='flex gap-52'>
                        ...
                        <Link to='/profedit'><button className='px-4 h-8 ml- mt-1 text-center hover:bg-indigo-400  text-white text-sm font-medium btn bg-indigo-500 rounded-xl'>Edit Profile</button></Link>                 </div>
            ...
            <div className="pic ml-24 mt-3">
                <div className='flex gap-0 ml-40 font-semibold cursor-pointer'>
                    <h1 className='w-40  text-center border-black flex'><FaRegSquarePlus className='mr-1 mt-[3px]'/>POSTS</h1>
                    <h1 className='w-40  text-center border-black flex'><FiVideo className='mr-1 mt-[3px]'/>REELS</h1>
                    <h1 className='w-40  text-center border-black flex' ><FaRegBookmark className='mr-1 mt-[3px]'/>SAVED</h1>
                </div>
