        ...
        <div className="nav-comp  md:block mt-6 ">
          ...
          <div className="nav-items mt-4 ml- rounded-xl w-[248px] cursor-pointer ">
            <ul className='ml-3 rounded-xl '>
              ...
              <Link to='/chat'><h1 className='rounded-xl pt-[14px] h-14 flex  pl-10 w-56 text-[16px] font-semibold hover:bg-indigo-500'><RiMessage2Line className='mt mr-5  text-2xl -ml-3'/>Message</h1></Link>
              <Link to='/notification'><li className='rounded-xl h-14 flex  pl-10 pt-[14px] w-56 text-[16px] font-semibold hover:bg-indigo-500'><FaRegHeart className='mt- mr-5  text-2xl -ml-3'/>Notification</li></Link>
