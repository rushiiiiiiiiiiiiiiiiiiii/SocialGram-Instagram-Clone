...
//                 <img src={`http://127.0.0.1:8000/uploads/${data.photos}`} alt="" className='w-[500px] object-contain h-80 items-center ml-5 pb-4' />
//               ) : isVideo(data.photos) ? (
//                 // <video src={`http://127.0.0.1:8000/uploads/${data.photos}`} controls autoPlay className='w-[500px] object-contain h-80 items-center ml-5 pb-4' />
//                 <video src={`http://127.0.0.1:8000/uploads/${data.photos}`} loop  autoPlay className='w-[500px] object-contain h-80 items-center ml-5 pb-4' />
...
// import React, { useState, useEffect, useRef } from 'react';
// import { IoSettingsOutline } from "react-icons/io5";
// import { FaBars, FaHeart, FaRegComment, FaPlay, FaPause } from "react-icons/fa";
// import { BiShareAlt } from "react-icons/bi";
// import { FaRegBookmark } from "react-icons/fa";
// import { FaRegHeart } from "react-icons/fa";
// import axios from 'axios';
...
//   const [sdata, setSdata] = useState([]);
//   const [comment, setComment] = useState([]);
//   const [muted, setMuted] = useState(true); // State for muted audio
...
//                   autoPlay={false}
//                 />
//                 <div id={`overlay-${data.id}`} className={`play-pause-overlay ${isPlaying ? 'active' : ''}`}>
//                   {isPlaying ? <FaPause className='play-icon' /> : <FaPlay className='play-icon' />}
//                 </div>
//                 <button className="ml-5 mt-2 px-2 py-1 bg-blue-500 text-white rounded" onClick={() => handleVideoClick(data.id)}>
//                   {isPlaying ? "Pause" : "Play"}
//                 </button>
//                 <button className="ml-5 mt-2 px-2 py-1 bg-gray-500 text-white rounded" onClick={toggleMute}>
//                   {muted ? "Unmute" : "Mute"}
//                 </button>
//               </div>
//             ) : null}
