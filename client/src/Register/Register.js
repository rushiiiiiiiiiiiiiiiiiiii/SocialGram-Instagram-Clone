...
//         <input onChange={e=>setFile(e.target.files)} type="file" required placeholder='Enter Full Name' name="photo" className='p-3 mx-4 my-3 border-2 border-black' />
//         <input onChange={e=>setName(e.target.value)} type="text" required placeholder='Enter Full Name' name="name" className='p-3 mx-4 my-3 border-2 border-black' />
//         <input onChange={e=>setUname(e.target.value)} type="text" required placeholder='Enter User Name' name="uname" className='p-3 mx-4 my-3 border-2 border-black' />
//         <input onChange={e=>setEmail(e.target.value)} type="email" required placeholder='Enter Email' name="email" className='p-3  mx-4 my-3  border-2 border-black' />
//         <input onChange={e=>setPassword(e.target.value)} type="password" required placeholder='Enter Password' name="password" class='p-3  mx-4 my-3  border-2 border-black' />
//         <button onClick={handleSubmit} className='bg-indigo-600 p-3   mx-4 my-3 text-lg font-semibold mb- hover:bg-indigo-400 '>{loader?<BeatLoader/>:"Register"}</button>
